...
@onready var cb_file_name  : CheckBox = $Check_List/container/FileName
@onready var cb_invalid_signature : CheckBox = $Check_List/container/Extension
@onready var cb_src_email : CheckBox = $Check_List/container/FileSize
@onready var cb_size_large : CheckBox = $Check_List/container/Publisher
@onready var cb_size_large2 : CheckBox = $Check_List/container/Source
@onready var btn_evaluate : Button = $Check_List/container/EvaluateButton
...
func spawn_new_filetizen():
	...
	filetizen.move_component.appear_bounce()
	move_filetizen_to_center()
